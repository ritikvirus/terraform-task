...
module "ecs_service" {
  ...
  discovery_namespace_id = var.public_namespace_id
  ...
  # Necessary arguments for using public dns
  # You need the hosted zone id of the original route 53 domain
  discovery_use_public_dns                       = true
  discovery_original_public_route53_zone_id      = var.original_public_route53_zone_id
  discovery_public_dns_namespace_route53_zone_id = var.public_namespace_hosted_zone
